...
@Component({
  selector: 'app-guide-michelin',
  templateUrl: './guide-michelin.component.html',
  styleUrls: ['./guide-michelin.component.scss']
})
export class GuideMichelinComponent implements OnInit {
  ...
  navigateToRestaurant(id,libelle){
    this.router.navigate([`restaurants/michelin-modify`], { queryParams: { id: id, Libelle: libelle } });
  }

  ajouter(){
    this.router.navigate([`restaurants/michelin-add/`], );
  }
