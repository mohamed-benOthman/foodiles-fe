...
@Component({
  selector: 'app-moyens-paiement',
  templateUrl: './moyens-paiement.component.html',
  styleUrls: ['./moyens-paiement.component.scss']
})
export class MoyensPaiementComponent implements OnInit {
  ...
  navigateToRestaurant(id,libelle){
    this.router.navigate([`restaurants/paiement-modify`], { queryParams: { id: id, Libelle: libelle } });
  }

  ajouter(){
    this.router.navigate([`restaurants/paiement-add/`], );
  }
